      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-8 space-y-6 sm:space-y-8">
            ...
            <div className="block lg:hidden w-full mb-6 rounded-3xl overflow-hidden border-2 border-orange-500/50 shadow-2xl shadow-orange-950/80 group relative">
            ...
            {/* Kesari Top Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-orange-950/70 border border-orange-500/40 text-orange-400 text-xs sm:text-sm font-bold tracking-wide shadow-lg backdrop-blur-md">
            ...
            <div className="max-w-2xl bg-[#12171c]/90 border-l-4 border-orange-500 p-4 sm:p-5 rounded-r-2xl backdrop-blur-md shadow-xl border-t border-r border-b border-orange-500/15">
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-4 pt-2">
              ...
              <a
                ...
                className="px-6 py-3.5 bg-gradient-to-r from-emerald-600 via-green-600 to-emerald-700 hover:from-emerald-500 hover:to-green-500 text-white rounded-xl font-extrabold text-sm sm:text-base flex items-center gap-2.5 shadow-xl shadow-green-950/60 hover:shadow-green-600/40 transition transform hover:-translate-y-0.5 active:translate-y-0 cursor-pointer border border-green-400/40"
              >
              ...
              <a
                ...
                className="px-5 py-3.5 bg-[#161c22] hover:bg-orange-950/80 text-orange-300 hover:text-white border border-orange-500/50 hover:border-orange-400 rounded-xl font-bold text-sm sm:text-base flex items-center gap-2.5 shadow-lg backdrop-blur-sm transition transform hover:-translate-y-0.5"
              >
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2 text-sm text-gray-300">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-4 border-t border-gray-800/80">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="glass-panel p-4 rounded-3xl border border-orange-500/40 shadow-2xl relative overflow-hidden space-y-3">
              ...
              <button
                ...
                className="w-full py-2.5 bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-500 hover:to-amber-500 text-white rounded-xl font-extrabold text-xs shadow-lg shadow-orange-950/60 transition text-center cursor-pointer flex items-center justify-center gap-2"
              >
